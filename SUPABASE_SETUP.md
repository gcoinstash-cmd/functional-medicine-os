# ⚡ 3-Minute Supabase Database Setup — Aura Protocol Functional Medicine OS
...
- Give it a name: `aura-protocol-clinic` and set your database password.
...
```
- Run `npm run build` or `npm run dev` to start serving your clinical operating system.
